 ...
 * After the initialization, you can access the singleton instance via {@link SpotifyApi#getInstance()}.
 *
 * Basic Usage:
 * - If you need to authorize user, use {@link SpotifyApi#authorize(android.content.Context, String[])}.
 * - If you are to access Web API, use {@link SpotifyApi#getApiService()}. Service object is generated by Retrofit.
 */
